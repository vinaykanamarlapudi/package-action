...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const repoInput = process.env.GITHUB_REPOSITORY || "Hello";
            // const repoDetails = repoInput!.split("/");
            const semver = core.getInput('semver');
            yield publishOciArtifact(repoInput, semver);
        }
        catch (error) {
...
function publishOciArtifact(repoInput, semver) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const publishPackageEndpoint = `https://api.github.com/repos/${repoInput}/releases`;
            //     const payload = {
            ...
            const response = yield axios_1.default.post(publishPackageEndpoint, payload, {
                headers: {
